...
import 'package:tumble/refactor/core/navigation/navigation_route_labels.dart';
import 'package:tumble/refactor/ui/root_page.dart';
...
class Routes {
  ...
  static List<String> pages = [
    NavigationRouteLabels.rootPage,
  ...
  static Page getPage(String page, {dynamic arguments}) {
    dynamic pageClass;
    switch (page) {
      case NavigationRouteLabels.rootPage:
        pageClass = const RootPage();
        break;
