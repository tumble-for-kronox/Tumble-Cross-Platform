...
import 'package:tumble/refactor/core/navigation/app_navigator_provider.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
        providers: [
          ...
          BlocProvider<RootPageCubit>(
            create: (c) => RootPageCubit(),
            child: Row(
              children: const [RootPage()],
            ),
          )
