...
import 'package:tumble/ui/home_page_widget/schedule_view_widgets/tumble_week_view/tumble_day_of_week_divider.dart';
import 'package:tumble/ui/home_page_widget/schedule_view_widgets/tumble_week_view/tumble_empty_week_event_tile.dart';
import 'package:tumble/ui/home_page_widget/schedule_view_widgets/tumble_week_view/tumble_week_event_tile.dart';
...
class TumbleDayOfWeekContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return day.events.isEmpty
        ...
        : Column(
            children:
                <Widget>[DayOfWeekDivider(day: day)] + day.events.map((e) => TumbleWeekEventTile(event: e)).toList(),
          );
  }
}
