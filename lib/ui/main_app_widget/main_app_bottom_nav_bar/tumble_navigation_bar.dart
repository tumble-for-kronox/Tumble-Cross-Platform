...
class TumbleNavigationBar extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => BlocBuilder<MainAppNavigationCubit, MainAppNavigationState>(
        builder: (context, mainappstate) {
          return BottomNavigationBar(
            ...
            elevation: 20,
            items: const [
              BottomNavigationBarItem(icon: Icon(CupertinoIcons.search), label: Labels.search),
