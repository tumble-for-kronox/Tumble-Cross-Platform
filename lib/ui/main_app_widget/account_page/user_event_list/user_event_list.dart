...
import 'package:tumble/ui/main_app_widget/account_page/widgets/available_event_card.dart';
    ...
    children: [
      ...
      Column(
        children: state.userEvents!.unregisteredEvents.isNotEmpty
            ? state.userEvents!.unregisteredEvents.map((e) => AvailableEventCard(event: e)).toList()
            : state.userEvents!.registeredEvents.map((e) => AvailableEventCard(event: e)).toList(),
      ),
      Padding(
