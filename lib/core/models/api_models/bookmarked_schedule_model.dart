...
Map<String, dynamic> bookmarkedScheduleModelToJson(BookmarkedScheduleModel data) => data.toJson();
...
abstract class BookmarkedScheduleModel with _$BookmarkedScheduleModel {
  ...
  factory BookmarkedScheduleModel.fromJson(Map<String, dynamic> json) => _$BookmarkedScheduleModelFromJson(json);
}
