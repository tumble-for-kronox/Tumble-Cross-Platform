...
class ScaffoldMessageType {
  static String failedToOpenStorePage(String storeType) =>
      Intl.message('Failed to open $storeType', args: [storeType]);
  ...
  static String cancelledAllSetNotifications() =>
      Intl.message('Cancelled all notifications');
  ...
  static String cancelNotificationsFailed(String objectName) =>
      Intl.message('Failed to cancel notifications for $objectName',
          args: [objectName]);

  static String openEventOptionsFailed() =>
      Intl.message('Schedule must be default to access options');
  ...
  static String openExternalUrlFailed(String name) =>
      Intl.message('Could not open $name', args: [name]);
