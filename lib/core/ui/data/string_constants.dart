...
class S {
  ...
  static EventOptionsStrings get eventOptions =>
      EventOptionsStrings(_localizedStrings!);
  static DetailsModalStrings get detailsModal =>
      DetailsModalStrings(_localizedStrings!);
  static SupportModalStrings get supportModal =>
      SupportModalStrings(_localizedStrings!);
  static ContributorsModalStrings get contributorsModal =>
      ContributorsModalStrings(_localizedStrings!);
}
